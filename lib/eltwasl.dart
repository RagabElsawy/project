        ...
        child: Column(
          ...
          children: [
            ListTile(
              ...
              trailing: Column(
                children: [Text('18:04'), Icon(Icons.navigate_next_rounded)],
              ),
            ),
            ListTile(
              leading: CircleAvatar(
            ...
            ListTile(
              ...
              trailing: Column(
                children: [Text('7:04'), Icon(Icons.navigate_next_rounded)],
              ),
            ),
            ListTile(
              leading: CircleAvatar(
